...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _toggleDevice(DeviceModel device) async {
    ...
    final success = await DeviceService.toggleDevice(device.id, newStatus);
    if (success) {
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                padding: const EdgeInsets.all(8),
                decoration: BoxDecoration(
                  color: isOn ? Colors.white.withOpacity(0.2) : Colors.blue.shade50,
                  shape: BoxShape.circle,
                ),
                child: Icon(
                  device.name.toLowerCase().contains('lamp') ? Icons.lightbulb_outline : Icons.power_settings_new,
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.bold,
              color: isOn ? Colors.white : const Color(0xFF1F1F1F),
            ),
          ),
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 13,
              color: isOn ? Colors.white.withOpacity(0.8) : Colors.black38,
              fontWeight: FontWeight.w500,
            ),
          ),
        ],
